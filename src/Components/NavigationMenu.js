...
export default function NavigationMenu({ closeMenu, pageList }) {
  ...
  return (
    <div className="fixed z-40 inset-0 md:static md:-mr-10 lg:min-w-max">
      <div className="absolute inset-0 md:hidden" onClick={closeMenu}></div>
      <div className="w-2/3 md:w-auto min-h-screen md:min-h-max bg-white/[0.04] backdrop-blur-2xl absolute md:static top-0 right-0 pl-6 pt-10 lg:pt-7 md:px-10 lg:pl-20 lg:pr-32">
        ...
        <NavList
          ...
          listClass="mb-4 md:mb-0 border-r-2 md:border-0 md:border-b-2 border-transparent hover:border-white-500 py-1 md:py-0 md:pb-10 lg:pb-7"
